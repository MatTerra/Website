          ...
          <div
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up"
              ...
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <path className="stroke-current text-blue-100"
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100"
              ...
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <path className="stroke-current text-blue-100" strokeWidth="2" strokeLinecap="square"
                      d="M21 23h22v18H21z" fill="none" fillRule="evenodd"/>
                <path className="stroke-current text-blue-300" d="M26 28h12M26 32h12M26 36h5" strokeWidth="2"
                      strokeLinecap="square"/>
              </svg>
              <h4 className="h4 mb-2">Code Review</h4>
              <p className="text-lg text-gray-400 text-center">Um acompanhamento detalhado do código irá previnir erros
                comuns e problemas futuros.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200"
              ...
              <h4 className="h4 mb-2">Desenho e Arquitetura</h4>
              <p className="text-lg text-gray-400 text-center">Um design bem feito no começo irá acelerar o
                desenvolvimento do seu produto e facilitar o processo de escala.</p>
            </div>
